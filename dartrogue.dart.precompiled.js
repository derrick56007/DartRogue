...
["GAME", "Game.dart", , A, {
  ...
  Game: {
    ...
    static: {Game$: function() {
        var t1 = new A.Game(null, Math.pow(2, 32));
        t1.Game$0();
        return t1;
      }}
  }
...
["ROOM", "World/Room/Room.dart", , R, {
  ...
  Room: {
    ...
    Room$5: function(minX, minY, width, height, roomType) {
      ...
      t4 = t4 - t3 + 1;
      this.height = t4;
      this.midX = t1 + C.JSNumber_methods._tdivFast$1(t2, 2);
      this.midY = t3 + C.JSNumber_methods._tdivFast$1(t4, 2);
...
function dart_precompiled($collectedClasses) {
  ...
  Window.prototype.get$closed = function(receiver) {
  ...
  Armor.builtin$cls = "Armor";
  if (!"name" in Armor)
    Armor.name = "Armor";
  $desc = $collectedClasses.Armor;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Armor.prototype = $desc;
  function ArmorType(def, value, NAME) {
    this.def = def;
    this.value = value;
    this.NAME = NAME;
  }
  ArmorType.builtin$cls = "ArmorType";
  if (!"name" in ArmorType)
    ArmorType.name = "ArmorType";
  $desc = $collectedClasses.ArmorType;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ArmorType.prototype = $desc;
  ...
  Chest.builtin$cls = "Chest";
  if (!"name" in Chest)
    Chest.name = "Chest";
  $desc = $collectedClasses.Chest;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Chest.prototype = $desc;
  ...
  Display.builtin$cls = "Display";
  if (!"name" in Display)
    Display.name = "Display";
  $desc = $collectedClasses.Display;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Display.prototype = $desc;
  function Entity(HP, tileObject) {
    this.HP = HP;
  ...
  Entity.prototype.get$HP = function() {
    return this.HP;
  };
  Entity.prototype.get$tileObject = function() {
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Enum.prototype = $desc;
  Enum.prototype.get$NAME = function() {
    return this.NAME;
  };
  function Game(seed, randMax) {
    this.seed = seed;
  ...
  function Input_keyUpHandler_closure(this_0) {
    this.this_0 = this_0;
  }
  Input_keyUpHandler_closure.builtin$cls = "Input_keyUpHandler_closure";
  if (!"name" in Input_keyUpHandler_closure)
    Input_keyUpHandler_closure.name = "Input_keyUpHandler_closure";
  $desc = $collectedClasses.Input_keyUpHandler_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Input_keyUpHandler_closure.prototype = $desc;
  function Input_keyDownHandler_closure(this_0, e_1) {
    this.this_0 = this_0;
    this.e_1 = e_1;
  }
  Input_keyDownHandler_closure.builtin$cls = "Input_keyDownHandler_closure";
  if (!"name" in Input_keyDownHandler_closure)
    Input_keyDownHandler_closure.name = "Input_keyDownHandler_closure";
  $desc = $collectedClasses.Input_keyDownHandler_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Item.prototype = $desc;
  function ItemType(value, NAME) {
    this.value = value;
    this.NAME = NAME;
  }
  ItemType.builtin$cls = "ItemType";
  if (!"name" in ItemType)
    ItemType.name = "ItemType";
  $desc = $collectedClasses.ItemType;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  Monster.prototype.get$followingCountdown = function() {
    return this.followingCountdown;
  };
  Monster.prototype.get$pathToPlayer = function() {
    return this.pathToPlayer;
  };
  function MonsterType(value, NAME) {
    this.value = value;
    this.NAME = NAME;
  }
  MonsterType.builtin$cls = "MonsterType";
  if (!"name" in MonsterType)
    MonsterType.name = "MonsterType";
  $desc = $collectedClasses.MonsterType;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  function PlayerType(value, NAME) {
    this.value = value;
    this.NAME = NAME;
  }
  PlayerType.builtin$cls = "PlayerType";
  if (!"name" in PlayerType)
    PlayerType.name = "PlayerType";
  $desc = $collectedClasses.PlayerType;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  Room.builtin$cls = "Room";
  if (!"name" in Room)
    Room.name = "Room";
  $desc = $collectedClasses.Room;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Room.prototype = $desc;
  function RoomType(value, NAME) {
    this.value = value;
    this.NAME = NAME;
  }
  RoomType.builtin$cls = "RoomType";
  if (!"name" in RoomType)
    RoomType.name = "RoomType";
  $desc = $collectedClasses.RoomType;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  TileObject.builtin$cls = "TileObject";
  if (!"name" in TileObject)
    TileObject.name = "TileObject";
  $desc = $collectedClasses.TileObject;
  if ($desc instanceof Array)
    $desc = $desc[1];
  TileObject.prototype = $desc;
  TileObject.prototype.get$type = function(receiver) {
    return this.type;
  };
  TileObject.prototype.get$isOpaque = function() {
    return this.isOpaque;
  };
  TileObject.prototype.get$isVisible = function() {
    return this.isVisible;
  };
  TileObject.prototype.set$isVisible = function(v) {
    return this.isVisible = v;
  };
  TileObject.prototype.get$isSolid = function() {
    return this.isSolid;
  };
  ...
  TileObject.prototype.get$f = function() {
    return this.f;
  };
  TileObject.prototype.get$closed = function(receiver) {
    return this.closed;
  };
  TileObject.prototype.set$closed = function(receiver, v) {
    return this.closed = v;
  };
  TileObject.prototype.get$parent = function(receiver) {
    return this.parent;
  };
  function TileType(value, NAME) {
    this.value = value;
    this.NAME = NAME;
  }
  TileType.builtin$cls = "TileType";
  if (!"name" in TileType)
    TileType.name = "TileType";
  $desc = $collectedClasses.TileType;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  Weapon.builtin$cls = "Weapon";
  if (!"name" in Weapon)
    Weapon.name = "Weapon";
  $desc = $collectedClasses.Weapon;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Weapon.prototype = $desc;
  function WeaponType(atk, value, NAME) {
    this.atk = atk;
    this.value = value;
    this.NAME = NAME;
  }
  WeaponType.builtin$cls = "WeaponType";
  if (!"name" in WeaponType)
    WeaponType.name = "WeaponType";
  $desc = $collectedClasses.WeaponType;
  if ($desc instanceof Array)
    $desc = $desc[1];
  WeaponType.prototype = $desc;
  ...
  function World_timeStepMonsters_closure() {
  }
  World_timeStepMonsters_closure.builtin$cls = "World_timeStepMonsters_closure";
  if (!"name" in World_timeStepMonsters_closure)
    World_timeStepMonsters_closure.name = "World_timeStepMonsters_closure";
  $desc = $collectedClasses.World_timeStepMonsters_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  World_timeStepMonsters_closure.prototype = $desc;
  ...
  function Grid(width, height, nodes) {
    this.width = width;
    this.height = height;
    this.nodes = nodes;
  }
  ...
  if ($desc instanceof Array)
    $desc = $desc[1];
  Grid.prototype = $desc;
  function Heap(cmp, nodes) {
    this.cmp = cmp;
    this.nodes = nodes;
  }
  Heap.builtin$cls = "Heap";
  if (!"name" in Heap)
    Heap.name = "Heap";
  $desc = $collectedClasses.Heap;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Heap.prototype = $desc;
  ...
  if (!"name" in AStarFinder)
    AStarFinder.name = "AStarFinder";
  $desc = $collectedClasses.AStarFinder;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ...
  if (!"name" in AStarFinder_findPath_closure)
    AStarFinder_findPath_closure.name = "AStarFinder_findPath_closure";
  $desc = $collectedClasses.AStarFinder_findPath_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
